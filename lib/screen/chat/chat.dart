                              ...
                              children: [
                                if (i % 2 == 0)
                                  Container(
                                    ...
                                    child:
                                        Text(ctrl.findRelativeTime(ctrl.MessageList[i].DateTime!, context), textAlign: TextAlign.center, style: TextStyle(color: Color(0xff5C628F), fontFamily: "hk")),
                                  ),
                                if (ctrl.MessageList[i].isUser!)
                                  personMessage(ctrl.MessageList[i].Message!)
                                else if (ctrl.MessageList[i].isbot!)
                                  botMessage(ctrl.MessageList[i].Message!, i == ctrl.MessageList.length - 1 && typingEffect)
                                else
                                  Container(
                                    margin: EdgeInsets.symmetric(vertical: 10),
                                    child:
                ...
                child: TextField(
                  ...
                  onSubmitted: (value) async {
                    ...
                    if (trimmedValue.isNotEmpty) {
                      ...
                      ctrl.addCategoryToChatHistory(ctrl.SelectedCategory!, widget.instance, trimmedValue);
                      ...
                      sendMessage(trimmedValue, widget.instance);
                    }
                  },
                  style: TextStyle(fontFamily: "hk", color: Colors.white54),
                  maxLines: null,
                  decoration: InputDecoration(
                      ...
                      suffixIcon: InkWell(
                        onTap: () async {
                          ...
                          String trimmedMessage = messageText.text.trim(); // Trim the message to remove leading and trailing whitespaces

                          if (trimmedMessage.isNotEmpty) {
                            if (widget.newInstance) {
                              ctrl.addCategoryToChatHistory(ctrl.SelectedCategory!, instance, trimmedMessage);
                              widget.newInstance = false;
                              instance++;
                            }

                            sharedPref.setInt(ctrl.SelectedCategory!.title!, instance);
                            sendMessage(trimmedMessage, widget.instance);
