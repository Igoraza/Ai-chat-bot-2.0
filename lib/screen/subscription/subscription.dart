                  ...
                  child: Column(
                    ...
                    children: [
                      GradientText(
                        ...
                        style: TextStyle(fontSize: density(20), fontWeight: FontWeight.w700, fontFamily: "hk"),
                      ),
                      ...
                      Container(
                        child: Center(
                          child: Text(
                            'Choose the Plan',
                            style: TextStyle(fontSize: density(16), fontFamily: "hk", fontWeight: FontWeight.w500, color: Color(0xff5C628F)),
                          ),
                        ),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: bluebox("10", "Weekly", context),
                          ),
                          GestureDetector(
                            onTap: () async {
                              try {
                            ...
                            child: bluebox("7", "Monthly", context),
                          )
                        ],
                      ),
                      SizedBox(
                              ...
                              Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(20), gradient: LinearGradient(colors: [Color(0xffDF6C83), Color(0xffF38A83), Color(0xff9979C8), Color(0xff346BD6)])),
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Text(
                                          "\$2 ",
                                          style: TextStyle(fontSize: 19 * ratio, color: Colors.white, fontWeight: FontWeight.w600),
                                        ),
                                        Text(
                                          "/Week",
                                          style: TextStyle(fontSize: 18 * ratio, color: Colors.white, fontWeight: FontWeight.w400),
                                        ),
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Color(0xff5C628F), fontSize: 11 * ratio, fontFamily: "hk"),
                        ),
                      )
                    ],
                  ),
