...
bluebox(String amount, String type, BuildContext context) {
  ...
  return GestureDetector(
    onTap: (() async {
      try {
        // GetPaywallsResult? paywallResult = await Adapty.getPaywalls();
        // final paywall = paywallResult!.paywalls;
        // await Adapty.makePurchase(paywall![0].products![0]);
      } catch (e) {}
    }),
    child: Container(
      ...
      child: Center(
        ...
        children: [
          Text(
            '\$${amount}/Week',
            style: TextStyle(fontSize: 17 * ratio, fontFamily: "hk", fontWeight: FontWeight.bold, color: Colors.white),
          ),
          SizedBox(
            height: 5 * ratio,
          ),
